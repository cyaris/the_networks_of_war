...
select
    ...
    b.participant,
    c.timeframe,
    if(columns('^(terrorism_deaths|mid_dyads|mid_dyads_initiated|mid_dyads_targeted|mid_dyads_joined|allied_countries|trade_countries|imports|exports|urban_population_growth_rate|cinc_score|land_mass_exchange_gain|population_exchange_gain|land_mass_exchange_loss|population_exchange_loss|concurrent_wars)$') in (-9, -8) or (columns('^(terrorism_deaths|mid_dyads|mid_dyads_initiated|mid_dyads_targeted|mid_dyads_joined|allied_countries|trade_countries|imports|exports|urban_population_growth_rate|cinc_score|land_mass_exchange_gain|population_exchange_gain|land_mass_exchange_loss|population_exchange_loss|concurrent_wars)$') is null and b.c_code <= 0), null, coalesce(columns('^(terrorism_deaths|mid_dyads|mid_dyads_initiated|mid_dyads_targeted|mid_dyads_joined|allied_countries|trade_countries|imports|exports|urban_population_growth_rate|cinc_score|land_mass_exchange_gain|population_exchange_gain|land_mass_exchange_loss|population_exchange_loss|concurrent_wars)$'), 0)),
    if(columns('^(money_flow_in|money_flow_out)$') in (-9, -8) or (columns('^(money_flow_in|money_flow_out)$') is null and b.c_code <= 0), null, coalesce(columns('^(money_flow_in|money_flow_out)$'), 0) * 1000000),
    if(columns('^(military_expenditure|military_personnel|population|urban_population|refugees_originated|refugees_hosted|internally_displaced_persons)$') in (-9, -8) or (columns('^(military_expenditure|military_personnel|population|urban_population|refugees_originated|refugees_hosted|internally_displaced_persons)$') is null and b.c_code <= 0), null, coalesce(columns('^(military_expenditure|military_personnel|population|urban_population|refugees_originated|refugees_hosted|internally_displaced_persons)$'), 0) * 1000),
    if(columns('^(iron_steel_production|energy_consumption)$') in (-9, -8) or (columns('^(iron_steel_production|energy_consumption)$') is null and b.c_code <= 0), null, coalesce(columns('^(iron_steel_production|energy_consumption)$'), 0) * 2000000)
