...
select
    ...
    a.c_code_a,
    a.c_code_b,
    clean_participant(c.state_name, e."replacement") participant_a,
    clean_participant(d.state_name, f."replacement") participant_b,
...
left join participant_name_replacements e on clean_text(c.state_name) = e."source"
left join participant_name_replacements f on clean_text(d.state_name) = f."source"
