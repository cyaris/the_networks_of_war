...
- When adding, removing, renaming, or recalculating backend metrics, update
  `frontend/src/lib/static/metricDataDictionary.json` in the same change. Align README source, calculation, unit, and
  metric summaries with that file.
