...
`svelte-lib-ref`; automatic runs use `SVELTE_LIB_REF` when set. Production uploads require a pinned 40-character
`svelte-lib` commit SHA.
...
complete through `40b4eab2ed2f58fb496b5a8552cdf417339e8a4d`; `auto-release.yml` remains available for manual historical
